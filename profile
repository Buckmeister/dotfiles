...
# ============================================================================
# Dotfiles Profile Manager - Cross-Platform Shell Wrapper
# Ensures zsh is available before running the profile manager
# ============================================================================
...
if ! command -v zsh >/dev/null 2>&1; then
    ...
    echo ""
    echo "The dotfiles profile manager requires zsh to run properly."
    echo ""
...
# Check if the profile manager script exists
PROFILE_SCRIPT="$SCRIPT_DIR/bin/profile_manager.zsh"
if [ ! -f "$PROFILE_SCRIPT" ]; then
    echo "❌ ERROR: Profile manager script not found at: $PROFILE_SCRIPT"
    echo ""
...
# Make sure the profile manager script is executable
if [ ! -x "$PROFILE_SCRIPT" ]; then
    chmod +x "$PROFILE_SCRIPT"
fi

# Everything looks good - hand off to the profile manager script
echo "✅ zsh found - launching profile manager..."
echo ""

# Execute the profile manager with zsh, preserving all arguments
exec zsh "$PROFILE_SCRIPT" "$@"

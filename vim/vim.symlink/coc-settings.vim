...
nnoremap <Leader>lsw <Cmd>CocSearch <C-R>=expand("<cword>")<CR><CR>
...
nmap <leader>lal <Plug>(coc-codeaction-selected)
...
nnoremap <silent> <space>lla  :<C-u>CocList diagnostics<cr>
" Manage extensions.
...
nnoremap <silent> <space>llr  :<C-u>CocListResume<CR>

" Explorer
:nmap <space>er :CocCommand explorer<CR>
...
" List all presets
nmap <space>lp :CocList explPresets
